...
const ITEMS: { id: Tab; label: string; icon: (active: boolean) => JSX.Element }[] = [
  ...
  },
  {
    ...
    icon: (a) => <svg width="22" height="22" fill={a?'currentColor':'none'} stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>,
  },
];
